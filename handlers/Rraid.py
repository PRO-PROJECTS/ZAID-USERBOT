...
@Client.on_message(filters.me | filters.user(SUDO_USERS) & filters.command(["replyraid", "rraid"], ["."]))
...
@Client.on_message(filters.me | filters.user(SUDO_USERS) & filters.command(["dreplyraid", "drraid"], ["."]))
